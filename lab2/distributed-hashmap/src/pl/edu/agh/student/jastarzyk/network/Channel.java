...
public class Channel extends JChannel {
    ...
    public Channel() throws Exception {
        ...
        stack
                .addProtocol(new UDP()
                        .setValue("mcast_group_addr", InetAddress.getByName("230.200.216.3")))
    ...
    public void init(String clusterName, DistributedMap map) throws Exception {
        this.setReceiver(new Receiver(this, map));
        this.connect(clusterName);
